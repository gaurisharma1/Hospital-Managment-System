  ...
  <div align="center" style="padding : 70px;">
    <table>
        <tr style="background-color:black;" align="center">
            ...
            <th style="padding:10px; font-size:20px; color:white;">Canecl Appointment</th>
        </tr>
        ...
        <tr style="background-color:black;" align="center">
            ...
            <td><a class="bt btn-danger" onclick="return confirm('Are you sure you want to cancel?')" href="{{url('cancel_appoint',$appoints->id)}}">Cancel</td>
        </tr>
